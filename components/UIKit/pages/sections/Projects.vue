                ...
                <div class="row">
                    <div class="col-md-6 px-0">
                        <card type="background" class="card-background-product card-no-shadow"
                              style="background-image: url('img/project/project1.jpg')">
                    ...
                    <div class="col-md-6 px-0">
                        <card type="background" raised class="card-background-product card-no-shadow"
                              style="background-image: url('img/project/project18.jpg')">
                    ...
                    <div class="col-md-6 px-0">
                        <card type="background"
                              ...
                              style="background-image: url('img/project/project20.jpg')">
                    ...
                    <div class="col-md-6 px-0">
                        <card type="background"
                              class="card-background-product card-no-shadow"
                              style="background-image: url('img/project/project19.jpg')">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="image-container image-left"
                                 style="background-image: url('img/project/project4.jpg')">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="image-container image-right"
                                 style="background-image: url('img/project/project21.jpg')">
                            </div>
                ...
                <div class="section-story-overview">
                    <div class="row">
                        <div class="col-md-6">
                            <!-- First image on the left side -->
                            <div class="image-container image-left"
                                 style="background-image: url('img/project/project24.jpg')">
                        ...
                        <div class="col-md-5">
                            <!-- First image on the right side, above the article -->
                            <div class="image-container image-right"
                                 style="background-image: url('img/project/project23.jpg')">
                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6 px-0">
                        <card type="background" class="card-fashion"
                              style="background-image: url('img/project/project14.jpg')">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 px-0">
                        <div class="card-container">
                            ...
                            <card type="background" class="card-fashion"
                                  style="background-image: url('img/project/project15.jpg')">
                            </card>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 px-0">
                        <div class="card-container">
                            <card type="background" class="card-fashion"
                                  style="background-image: url('img/project/project17.jpg')">
                            </card>
                    ...
                    <div class="col-md-6 px-0">
                        <card type="background" class="card-fashion"
                              style="background-image: url('img/project/project16.jpg')">
                            <div class="card-title text-left">
                                <h2>
        ...
        <div class="projects-5">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-5 ml-auto">
                        <card type="background" raised class="card-background-product"
                              style="background-image: url('img/project/project8.jpg')">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mr-auto">
                        <card type="background" raised class="card-background-product"
                              style="background-image: url('img/project/project9.jpg')">
...
<script>
  import { Card, InfoSection,  Badge, Button, Tabs, TabPane } from '@/components/UIKit';
