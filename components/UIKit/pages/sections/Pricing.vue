<template>
    <div class="cd-section" id="pricing">
        ...
        <div class="pricing-1 section-image" id="pricing-1"
             style="background-image: url('img/pricing/pricing1.jpg')">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <card type="pricing"
                              ...
                              style="background-image: url('img/pricing/pricing2.jpg')">
        ...
        <!--     *********    END PRICING 2      *********      -->
        <!--     *********    PRICING 3     *********      -->
        <div class="pricing-3 section-image" style="background-image: url('img/pricing/pricing3.jpg')" id="pricing-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 ml-auto mr-auto text-center">
                        <h2 class="title">Pick the best plan for you</h2>
        ...
        <div class="pricing-5 section-pricing-5 section-image" id="pricing-5"
             style="background-image: url('img/backgrounds/bg31.jpg')">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
...
<script>
  import { Card, Button, Tabs, TabPane } from '@/components/UIKit';
