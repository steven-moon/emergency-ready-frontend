<template>
    <div class="cd-section" id="teams" >
        ...
        <!--     *********    END TEAM 2      *********      -->
        <!--     *********    TEAM 3     *********      -->
        <div class="team-3 section-image" style="background-image: url('img/project/project21.jpg')">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto text-center">
        ...
        <!--     *********    END TEAM 4      *********      -->
        <!--     *********    TEAM 5     *********      -->
        <div class="team-5 section-image" style="background-image: url('img/project/project9.jpg')">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto text-center">
