<template>
    ...
    <div class="section subscribe-line subscribe-line-image" style="background-image: url('img/backgrounds/bg7.jpg')" v-if="showImage">
      <div class="container">
        <div class="row">
  ...
  export default {
    ...
    methods: {
      submitForm() {
        ...
        this.isLoading = true;
        CommonAPI.sendSubscribeForm(formData)
          .then(response => {
