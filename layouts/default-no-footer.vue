          ...
          <div class="row align-items-center justify-content-xl-between">
            <div class="col-xl-6">
              <div class="copyright text-center text-muted">
                © {{year}} <a href="https://clevercoding.com/" class="font-weight-bold ml-1" rel="noopener">Clever Coding LLC</a>
              </div>
            </div>
            <div class="col-xl-6">
              <ul class="nav nav-footer justify-content-center justify-content-xl-end">
                <li class="nav-item">
                  <a href="https://clevercoding.com/about" class="nav-link" target="_blank" rel="noopener">About Us</a>
                </li>
                <li class="nav-item">
                  <a href="https://clevercoding.com/blog/" class="nav-link" target="_blank" rel="noopener">Blog</a>
                </li>
                <li class="nav-item">
                  <a href="https://www.clevercoding.com/emergency-ready-app-privacy-policy" class="nav-link" target="_blank" rel="noopener">Privacy Policy</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        chatlio: "<script type=\"text/javascript\"> window._chatlio = window._chatlio||[]; !function(){ var t=document.getElementById(\"chatlio-widget-embed\");if(t&&window.ChatlioReact&&_chatlio.init)return void _chatlio.init(t,ChatlioReact);for(var e=function(t){return function(){_chatlio.push([t].concat(arguments)) }},i=[\"configure\",\"identify\",\"track\",\"show\",\"hide\",\"isShown\",\"isOnline\", \"page\", \"open\", \"showOrHide\"],a=0;a<i.length;a++)_chatlio[i[a]]||(_chatlio[i[a]]=e(i[a]));var n=document.createElement(\"script\"),c=document.getElementsByTagName(\"script\")[0];n.id=\"chatlio-widget-embed\",n.src=\"https://w.chatlio.com/w.chatlio-widget.js\",n.async=!0,n.setAttribute(\"data-embed-version\",\"2.3\"); n.setAttribute('data-widget-id','de2cd43d-9fce-4f7c-7bfd-5f73c1e6d35e');c.parentNode.insertBefore(n,c); }(); <\/script>",
      };
    },
    watch: {
      '$route.path'() {
