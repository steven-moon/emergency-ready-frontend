<template>
   <div class="black-container">
      ...
      >
         ...
         <ul class="navbar-nav">
            <nuxt-link class="nav-item" tag="li" to="/black/">
               <a class="nav-link text-primary">
                  <i class="tim-icons icon-minimal-left"></i> Back to Dashboard
               </a>
            </nuxt-link>
            <nuxt-link class="nav-item" tag="li" to="/black/register">
               <a class="nav-link">
                  <i class="tim-icons icon-laptop"></i> Register
               </a>
            </nuxt-link>

            <nuxt-link class="nav-item" tag="li" to="/black/login">
               <a class="nav-link">
                  <i class="tim-icons icon-single-02"></i> Login
               </a>
            </nuxt-link>

            <nuxt-link class="nav-item" tag="li" to="/black/pricing">
               <a class="nav-link"> <i class="tim-icons icon-coins"></i> Pricing </a>
            </nuxt-link>

            <nuxt-link class="nav-item" tag="li" to="/black/lock">
               <a class="nav-link">
...
<script>
    import { BaseNav } from '~/components/Black';
