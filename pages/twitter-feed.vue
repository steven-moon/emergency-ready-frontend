        ...
        <base-header class="pb-6">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Twitter Feed</h6>
...
<script>
    import TimeLine from '@/components/Argon/argon-core/Timeline/TimeLine.vue';
    import TimeLineItem from '@/components/Argon/argon-core/Timeline/TimeLineItem.vue';
