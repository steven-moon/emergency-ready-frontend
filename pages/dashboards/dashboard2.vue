...
<script>
   ...
   // Lists
   import ProgressTrackList from '~/components/Argon/pages/dashboard/ProgressTrackList';
   import MembersCard from '~/components/Argon/widgets/MembersCard';
   import TaskList from '~/components/Argon/widgets/TaskList';

   // Tables
   import LightTable from '~/components/Argon/pages/dashboard/LightTable';
   import VectorMapCard from '~/components/Argon/widgets/VectorMapCard'
