...
<script>
   import EditProfileForm from '~/components/Argon/pages/UserProfile/EditProfileForm.vue';
   import UserCard from '~/components/Argon/pages/UserProfile/UserCard.vue';
