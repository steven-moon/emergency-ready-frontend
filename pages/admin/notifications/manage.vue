...
<script>
    ...
    import { BasePagination } from '@/components/Argon/argon-core';
    import clientPaginationMixin from '~/components/Argon/tables/PaginatedTables/clientPaginationMixin'
    import swal from 'sweetalert2';
    import users from '~/components/Argon/tables/users2';
