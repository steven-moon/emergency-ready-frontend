  ...
  export default {
    ...
    data () {
      return {
        ...
        header: "Emergency Response Plans",
        pageText: "Not only can your areas custom emergency response plans be listed here so users have easy access " +
        ...
        imageURL: "/app-screenshots/emergency-response-plans-1.png",
      }
    },
    head () {
      return {
