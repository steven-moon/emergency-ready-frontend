...
export default {
  ...
  state: {
    whoIsCleverCoding: {
      ...
      description: 'We are an app development company focused on iOS, Android and Web App Development.  We are dedicated to delivering high quality apps that are build to scale from the ground up using current industry standards',
        ...
        },
        {
          ...
          info: [
            ...
            },
            {
              ...
              description: 'Our primary goal with new clients it to form a long term partnership. Our overage customer has been working with us for 5+ years',
              icon: 'now-ui-icons business_chart-bar-32',
              type: 'primary'
            },
            {
              title: 'Limited Projects',
              description: 'We only accept a limited number of new clients each year. We focus on working with companies who are looking for a long development partner.  We limit the number of active projects so that we can focus on providing high quality personal service to each client.',
      ...
      cards: [
        {
          ...
          description: '',
          category: 'Advantages',
          backgroundUrl: 'img/project/project1.jpg',
        ...
        },
        {
          ...
          backgroundUrl: 'img/project/project9.jpg',
          icon: 'now-ui-icons ui-1_send',
          link: 'https://clevercoding.com/',
          linkText: 'Clever Coding',
          badgeText: '',
          layout: '',
          info: []
        },
        {
          title: 'Clever Coding Advantages 2',
          description: '',
          category: 'Advantages 2',
          backgroundUrl: 'img/project/project1.jpg',
          icon: 'now-ui-icons ui-1_send',
          link: '',
          linkText: '',
  ...
  getters: {
    ...
    project1(state) {
      return clonedeep(state.project1)
    },
    appData(state) {
      return clonedeep(state.appData)
    },
    appDataSplit(state) {
      return clonedeep(state.appDataSplit)
    },
  },
  mutations: {
    reset(state) {
